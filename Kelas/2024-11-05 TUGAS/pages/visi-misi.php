...
$konten = ["Visi-misi", "VISI    :", "“BERIMAN, BERPRESTASI DAN BERKEPRIBADIAN TANGGUH”", "MISI    :", "1.TERWUJUDNYA PERKEMBANGAN YANG POSITIF DALAM DIRI SISWA TERUTAMA HAL MENTAL SPIRITUAL
2.TERWUJUDNYA RASA KEKELUARGAAN SEJARI BAGI SELURUH WARGA SEKOLAH
3.TERWUJUDNYA POTENSI SISWA DENGAN KEMAMPUAN YANG OPTIMAL 
4.TERKEMBANGNYA BAKAT SENI, OLAHRAGA DAN KETRAMPILAN SISWA AGAR DAPAT BERPRESTASI 
5.TERWUJUDNYA KEPEMIMPINAN PARTISIPATIF DALAM DIRI SETIAP WARGA SEKOLAH 
6.TERWUJUDNYA SEMANGAT BERKOMPETENSI UNTUK BERPRESTASI BAGI SELURUH SISWA</br>
7.TERWUJUDNYA LINGKUNGAN SEKOLAH YANG BERSIH"];
?>
...
<head>
    ...
    <title>Visi-Misi - SMPK YUSTINUS DE YACOBIS KRIAN</title>
    </style>
</head>
...
<body>
    ...
    <div class="content" data-aos="fade-right">
        <div class="kotak4">
            <br>
            <h2><?php echo $konten[0] ?></h2>
            <p style="margin-top:50px;"><?php echo $konten[1] ?></p>
            <p><b><?php echo $konten[2] ?></b></p>
            <p><?php echo $konten[3] ?></p>
            <p><b><?php echo $konten[4] ?></b></p>
        </div>
    </div>
