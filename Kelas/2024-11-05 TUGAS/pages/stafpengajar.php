...
$konten = ["Staf-Pengajar","SMP Katolik Santo Yustinus de Yacobis di Krian, Sidoarjo, merupakan lembaga pendidikan Katolik yang berdiri dengan tujuan menyediakan pendidikan berkualitas yang berlandaskan nilai-nilai keagamaan Katolik. Sekolah ini didirikan sebagai bagian dari misi pendidikan dan sosial Gereja Katolik, khususnya untuk melayani anak-anak di sekitar wilayah Krian, Sidoarjo.","Seiring dengan perkembangannya, SMP Katolik Santo Yustinus de Yacobis terus berupaya meningkatkan kualitas pendidikan, menyediakan fasilitas yang lebih baik, dan memperkuat program akademik dan ekstrakurikuler"];
?>
...
<head>
    ...
    <title>Staf-Pengajar - SMPK YUSTINUS DE YACOBIS KRIAN</title>
    </style>
</head>
...
<body>
    ...
    <div class="content" data-aos="fade-right">
        <div class="kotak4">
            <img src="../images/guru.png" width="500px" height=500px; alt="">
        </div>
    </div>
