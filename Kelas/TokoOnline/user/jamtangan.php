...
$products = $conn->query("SELECT * FROM products WHERE category = 'jam_tangan'");
...
<head>
    ...
    <title>Kaos Wanita - KaJaTu Store</title>
...
<body>
    ...
    <div class="banner">
        <div class="images">
            <img alt="Deskripsi gambar pertama" src="../images/banner3.png" />
        </div>
    </div>

    <h1>Koleksi Jam Tangan</h1>

    <div class="product-list animate-fade-in">
        <?php while ($row = $products->fetch_assoc()) { ?>
            <div class="product">
                <a href="detailjam.php?id=<?php echo htmlspecialchars($row['id']); ?>">
