...
$products = $conn->query("SELECT * FROM products WHERE category = 'sepatu'");
...
<body>
    ...
    <div class="banner">
        <div class="images">
            <img alt="Deskripsi gambar pertama" src="../images/banner4.png" />
        </div>
    </div>
    ...
    <div class="product-list animate-fade-in">
        <?php while ($row = $products->fetch_assoc()) { ?>
            <div class="product">
                <a href="detailsepatu.php?id=<?php echo htmlspecialchars($row['id']); ?>">
